...
<html><head>
  ...
  <body id="pakarayam" class="hold-transition skin-green-light sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="fa fa-stethoscope" aria-hidden="true"></i>PS</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="fa fa-stethoscope" aria-hidden="true"></i>Pakar Stunting</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Pakar Stunting</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <li class="user-body">
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2022 - Made with <i class="fa fa-heart pulse"></i> by <a href="" target="_blank">Kelompok 2</a></div></strong>
      </footer>
